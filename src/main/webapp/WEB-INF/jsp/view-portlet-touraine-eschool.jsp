                    ...
                    <div id="slider" class="esco-accueil clg37">
                        <ul>
                            ...
                            <li><img src="/esco-accueil/img/cg37.jpg"
                                alt="Collège : le Conseil départemental d'Indre-et-Loire crée les conditions de la réussite"></li>
                        ...
                        <ul>
                            <li><img src="/esco-accueil/img/thumb_touraine-eschool.jpg" alt="Touraine e-school" />
                                <div class="esco-accueil meta">
                                    ...
                                    <p>Un Environnement Numérique de travail pour tous les collégiens ...</p>
                                    <a class="readmore"
                                        href="/portail/f/touraine-eschool">En
                                        savoir plus </a>
                                </div></li>
                            <li><img src="/esco-accueil/img/thumb_cg37.jpg"
                                alt="Collège : le Conseil départemental d'Indre-et-Loire crée les conditions de la réussite" />
                                <div class="esco-accueil meta">
